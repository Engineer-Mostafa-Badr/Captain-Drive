...
class CaptainPasswordChangedSuccessfullyScreen extends StatefulWidget {
  const CaptainPasswordChangedSuccessfullyScreen({super.key});

  @override
  State<CaptainPasswordChangedSuccessfullyScreen> createState() =>
      _CaptainPasswordChangedSuccessfullyScreenState();
}

class _CaptainPasswordChangedSuccessfullyScreenState
    extends State<CaptainPasswordChangedSuccessfullyScreen> {
  @override
  void initState() {
