...
import 'package:captain_drive/screens/captain/chat/widgets/chat_list_view_builder_horizontal.dart';
import 'package:captain_drive/screens/captain/chat/widgets/recent_chats.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.search, color: AppColor.onBoardingColor),
                        SizedBox(width: 10),
                        Text(
                          'Search here',
                          style: TextStyle(
                              fontSize: 14, color: AppColor.onBoardingColor),
                        ),
                      ],
                    ),
                  ),
